...
\title{Order-Agnostic Autoregressive Diffusion Models:\\ A Cross-Modal Study on Images and Categorical Tabular Data}
\author{\IEEEauthorblockN{Jorge Barcenilla \quad S. Prieto}% TODO: confirm co-author name
\IEEEauthorblockA{Probabilistic Machine Learning, Universidad Carlos III de Madrid}}
...
a mean total-variation distance below 0.1. The results show that a single
...
5{,}000 validation and the standard 10{,}000 test images. Mushroom was encoded
...
\begin{figure}[t]
\centering
\includegraphics[width=\columnwidth]{tabular_marginals.pdf}
